...
class StudentAttendenceTable extends StatelessWidget {
  User user;
  StudentAttendenceTable({required this.user});
        ...
        children: [
          ...
          Scaffold(
            ...
            body: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('Attendence').where('Student id',isEqualTo: user.uid).snapshots(),
